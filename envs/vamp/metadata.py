...
def serialize_config(cfg: VampConfig) -> Dict[str, Any]:
    ...
    return {
        ...
        "proof_success_bonus": float(cfg.proof_success_bonus),
        "seed_bounty_price": float(cfg.seed_bounty_price),
        "bounty_accept_bonus": float(cfg.bounty_accept_bonus),
...
def deserialize_config(data: Dict[str, Any]) -> VampConfig:
    ...
    return VampConfig(
        ...
        proof_success_bonus=float(data.get("proof_success_bonus", 0.05)),
        seed_bounty_price=float(data.get("seed_bounty_price", 0.1)),
        bounty_accept_bonus=float(data.get("bounty_accept_bonus", 0.02)),
